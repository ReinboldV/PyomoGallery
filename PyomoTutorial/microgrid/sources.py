...
from base_units import AbsFlowSource, AbsFixedFlowSource, AbsFlowLoad, AbsFixedFlowLoad
...
class PVPanels(AbsScalablePowerSource):
    ...
    """
    def __init__(self):
        super().__init__(self, flow_name='p', scale_fact='Surf')
...
class AbsDebugSource(AbsPowerSource):
    ...
    def __init__(self, *args, flow_name='p', **kwds):
        ...
        from .cost import def_absolute_cost
